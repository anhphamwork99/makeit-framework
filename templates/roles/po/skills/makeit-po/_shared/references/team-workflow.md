...
```
PO Goal & Context ──────── WHY we build (business value) ← ⭐ YOU OWN THIS
    │
    ▼
...
| Design conflict với PO goal | **PO quyết định — goal wins** ⭐ |
