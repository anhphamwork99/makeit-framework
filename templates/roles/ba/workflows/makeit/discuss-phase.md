...
<objective>
Explore and clarify a phase's scope through adaptive questioning before creating a plan. Surfaces gray areas, gathers user decisions, and saves context to CONTEXT.md so the planner has clear direction.
</objective>

<execution_context>
@.agent/skills/makeit-ba/ba-planning/stage-discuss-phase.md
</execution_context>
...
<process>
  ...
  <step name="adaptive_questioning">
    ...
    - Analyze phase goal for ambiguities and gray areas
  ...
  <step name="save_context">
    ...
    Sections: Decisions (locked), Agent's Discretion (freedom areas), Deferred Ideas (out of scope).
  </step>
