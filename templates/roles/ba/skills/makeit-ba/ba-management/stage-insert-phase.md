---
name: ba-stage-insert-phase
description: Insert urgent BA work as decimal phase (e.g., 2.1) between existing phases in sprint ROADMAP
---

<purpose>
Handle urgent BA work discovered mid-sprint by inserting a decimal phase between existing phases without renumbering the entire roadmap.
</purpose>
