---
name: ba-stage-add-phase
description: Add a new phase to end of sprint ROADMAP — for planned work discovered during BA execution
---

<purpose>
Append a new phase for BA work discovered during sprint execution to the end of the active sprint's roadmap.
</purpose>

<rules>
1. New phase goes at end — never insert mid-sequence (use insert-phase for that)
2. BA-specific deliverables — phase should produce stories, flows, or analysis
...
<process>
  ...
  <step name="get_phase_details">
    ...
    Determine BA-specific deliverables this phase will produce.
  </step>
  ...
  <step name="update_roadmap">
    ...
    **Domain Workflow:** {relevant BA workflow}
    ```
  </step>
