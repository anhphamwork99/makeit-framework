---
name: tl-status
description: TL sprint status — show current state, phase progress, and suggested next command
---

<purpose>
Show current TL sprint state, phase progress, deliverable status, and suggest the next command. Lightweight command for quick orientation.
</purpose>
...
<process>
  ...
  > 💡 For detailed deliverable-level status, use `/makeit:progress`.
</process>
