---
name: be-stage-insert-phase
description: Insert urgent BE work as decimal phase (e.g., 2.1) between existing phases in sprint ROADMAP
---

<purpose>
Handle urgent BE work discovered mid-sprint by inserting a decimal phase between existing phases without renumbering the entire roadmap.
</purpose>
...
<process>
  ...
  <step name="update_roadmap">
    ...
    **Domain Workflow:** {relevant BE workflow}
