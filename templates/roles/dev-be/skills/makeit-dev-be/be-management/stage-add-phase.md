---
name: be-stage-add-phase
description: Add a new phase to end of sprint ROADMAP — for planned BE work discovered during implementation
---

<purpose>
Append a new phase for BE work discovered during sprint execution to the end of the active sprint's roadmap.
</purpose>

<rules>
1. New phase goes at end — never insert mid-sequence (use insert-phase for that)
2. BE-specific deliverables — phase should produce APIs, schemas, migrations, or integrations
...
<process>
  ...
  <step name="get_phase_details">
    ...
    Determine BE-specific deliverables this phase will produce.
  </step>
  ...
  <step name="update_roadmap">
    ...
    ### Phase {N}: {Name}
    **Goal:** {phase goal}
    **Deliverables:** {expected deliverables — APIs, schema, migrations, integrations}
    **Domain Workflow:** {implement, design-api, design-schema, etc.}
    ```
  </step>
