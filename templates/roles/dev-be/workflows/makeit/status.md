...
<execution_context>
@.agent/skills/makeit-dev-be/be-support/status.md
</execution_context>
...
<process>
  ...
  <step name="execute">
    ...
    - Phase progress bar
    - Deliverables produced so far (API contracts, migrations, tests)
    - Recent activity (last 3-5 actions from STATE.md)
    - Any blockers, open questions, or STOP items pending
  </step>
