---
name: fe-stage-insert-phase
description: Insert urgent FE work as decimal phase (e.g., 2.1) between existing phases in sprint ROADMAP
---

<purpose>
Handle urgent FE work discovered mid-sprint by inserting a decimal phase between existing phases without renumbering the entire roadmap.
</purpose>
...
<process>
  ...
  <step name="update_roadmap">
    ...
    **Domain Workflow:** {relevant FE workflow}
