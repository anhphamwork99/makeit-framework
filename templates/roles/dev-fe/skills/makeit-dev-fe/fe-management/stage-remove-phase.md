---
name: fe-stage-remove-phase
description: Remove a future phase from FE sprint ROADMAP and renumber subsequent phases
---

<purpose>
Clean removal of FE work decided not to do — removes unstarted future phase from the sprint roadmap and renumbers subsequent phases.
</purpose>
